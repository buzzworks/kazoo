...
-spec new_request/3 :: (pid(), ne_binary(), http_method()) -> 'ok'.
...
-spec handle_resp/3 :: (whapps_call:call(), ne_binary(), binary()) -> 'ok'.
...
-spec req_params/2 :: (ne_binary(), whapps_call:call()) -> wh_proplist().
