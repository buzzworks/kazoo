...
%% @end
%%--------------------------------------------------------------------
-spec get_merged_device(cb_context:context()) -> {ok, cb_context:context()} | {error, binary()}.
...
-spec merge_device(cb_context:context()) -> {ok, wh_json:json_object()} | {error, binary()}.
...
-spec get_account(ne_binary()) -> wh_json:json_object().
